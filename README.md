...
The bugs that were causing the above transaction closures are now fixed on most major browsers (recent versions). Hence this version of NoSQLProvider removes it. 
