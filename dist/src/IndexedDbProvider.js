...
var IndexedDbIndex = /** @class */ (function (_super) {
    ...
    IndexedDbIndex.prototype.getMultiple = function (keyOrKeys) {
        return __awaiter(this, void 0, void 0, function () {
            var e_1, _a, e_2, _b, keys, values, keys_2, keys_2_1, key, _c, _d, e_1_1, keys_3, keys_3_1, key, _e, _f, e_2_1;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        keys = lodash_1.attempt(function () {
                        ...
                        if (lodash_1.isError(keys)) {
                            return [2 /*return*/, Promise.reject(keys)];
                        }
                        values = [];
                        if (!(this._store.getAll && !this._fakeComplicatedKeys)) return [3 /*break*/, 9];
                        _g.label = 1;
                    case 1:
                        ...
                        _g.label = 2;
                    case 2:
                        if (!!keys_2_1.done) return [3 /*break*/, 5];
                        key = keys_2_1.value;
                        _d = (_c = values).concat;
                        return [4 /*yield*/, IndexedDbProvider.WrapRequest(this._store.get(key))];
                    case 3:
                        values = _d.apply(_c, [_g.sent()]);
                        _g.label = 4;
                    case 4:
                    ...
                    case 9:
                        ...
                        keys_3 = __values(keys), keys_3_1 = keys_3.next();
                        _g.label = 10;
                    case 10:
                        if (!!keys_3_1.done) return [3 /*break*/, 13];
                        key = keys_3_1.value;
                        _f = (_e = values).concat;
                        return [4 /*yield*/, this.getOnly(key)];
                    case 11:
                        values = _f.apply(_e, [_g.sent()]);
                        _g.label = 12;
                    case 12:
                        keys_3_1 = keys_3.next();
                        return [3 /*break*/, 10];
                    ...
                    case 15:
                        ...
                        return [7 /*endfinally*/];
                    case 16: return [2 /*return*/, Promise.resolve(values && values[0] === undefined ? [] : values)];
                }
            });
        });
    };
